   ...
   <div class="container">
      <div class="row" id="navcontainer" style="padding-bottom:6px;">
         <div class="col-lg-12 col-md-12 col-xs-12">
            <a href="<?php echo base_url();?>"><img src="<?php echo base_url()?>assets/frontview/img/logo3.svg"
                  class="logo_main"></a>
            <div class="float-right infobar">
               <span><i class="lnr lnr-phone-handset"></i>&nbsp;&nbsp;<span>Phone : (0711) 5610503</span></span>
               ...
               <a href="https://api.whatsapp.com/send?phone=++6281928529335&text=Assalamu'alaikum Wr Wb"
                  target="_blank"><span id="wa_navbar"><img src="<?= base_url();?>assets/frontview/img/wa.png"
                        style="color:#ffffff;height:15px;top:-2px;position: relative;">&nbsp;&nbsp;WhatsApp</span></a>
            </div>
         </div>
      </div>
   </div>
