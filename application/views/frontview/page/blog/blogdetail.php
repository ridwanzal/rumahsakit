      ...
      <div class="row">
         <div class="col-lg-8 col-md-8 col-xs-12">
            ...
            <img src="<?php echo base_url()?>assets/blog/thumb_img_default/thumb.png"
               style="width:inherit;margin-bottom:0px;border-radius:10px;">
            <?php }else{ ?>
            <img src="<?php echo base_url()?>assets/blog/thumb_img/<?php echo $row->image_path;?>"
               style="width:inherit;margin-bottom:0px;border-radius:10px;">
            <?php }
                        ?>
            <p class="date_image text-muted"><span style="font-weight:500;">Posted by : Admin&nbsp; -
                  &nbsp;</span><?php echo $row->date_created; ?></p>
            <div class="content">
               <?php
                            echo $row->content; 
                            ?>
         ...
         <div class="col-lg-4 col-md-4 col-xs-12">
            <img src="<?php echo base_url()?>assets/frontview/img/flyerblog.png"
               style="width:inherit;margin-bottom:30px;border-radius:10px;">
         </div>
      </div>
   </div>
</section>
      ...
      <div class="row">
         <div class="col-lg-8 col-md-8 col-xs-12">
            ...
            <div style="display:flex;" class="share_social">
               ...
               <a
                  href="https://api.whatsapp.com/send?text=<?php echo base_url();?>artikel/<?php $datapost->result()[0]->slug ?>"><img
                     src="https://bilba.go-jek.com/images/v4/custom/blog/whatsapp-social-icon-circle-color.svg"
                     alt="Whatsapp" /></a>
               <a
                  href="https://www.facebook.com/sharer/sharer.php?u=<?php echo base_url();?>artikel/<?php $datapost->result()[0]->slug ?>"><img
                     src="<?= base_url();?>assets/frontview/img/fb.png" alt="facebook" width="40px" /></a>
               <a
                  href="https://twitter.com/intent/tweet?text=<?php echo base_url();?>artikel/<?php $datapost->result()[0]->slug ?>"><img
