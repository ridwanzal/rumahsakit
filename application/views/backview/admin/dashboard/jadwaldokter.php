                    ...
                    <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                        ...
                                        <?php echo form_open_multipart('uploads/single/jadwaldokter/jadwaldokter/jadwaldokter'); ?>
                                                    ...
                                                    <?php
                                                        function check_empty($value){
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><img style="height:50px;border-radius:4px;" src="<?php echo base_url()?>/assets/jadwaldokter/<?php echo $list->image_name;?>"></td>
                                                                <td><?php echo $list->caption;?></td>
                                                                <th><a href="<?php echo base_url()?>uploads/delete/<?php echo $list->id; ?>/jadwaldokter" class="btn btn-danger btn-xs">Delete</a></th>
                                                            </tr>
                                                        <?php }
                                                    ?>
                                                </tbody>
