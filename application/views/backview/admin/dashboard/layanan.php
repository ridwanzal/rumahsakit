	        ...
	        <div class="dashboard-influence">
	            <div class="container-fluid dashboard-content">
	                            ...
	                            <div class="page-breadcrumb">
	                                <nav aria-label="breadcrumb">
	                                    <ol class="breadcrumb">
	                                        ...
	                                        <li class="breadcrumb-item active" aria-current="page">Kelola Fasilitas Layanan</li>
	                                    </ol>
	                                </nav>
	                            </div>
	                        </div>
                    ...
                    <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                        <?php echo form_open_multipart('layanan/submit_layanan'); ?>
                                                ...
                                                <tbody>
                                                    <?php
                                                        function check_empty($value){
                                                            ...
                                                            $i = 0; 
                                                            foreach($daftar_layanan as $list){
                                                                $i = $i + 1;
                                                                ?>
                                                            <tr>
                                                                <td><?php echo $i; ?></td>
                                                                ...
                                                                <td><a href="<?php echo base_url()?>layanan/delete/<?php echo $list->id; ?>" class="btn btn-danger btn-xs">Delete</a></td>
                                                            </tr>
                                                        <?php }
                                                    ?>
                                                </tbody>
